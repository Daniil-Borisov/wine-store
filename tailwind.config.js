  ...
  theme: {
    ...
    extend: {
      ...
      colors: {
        ...
        'accent-hover': withOpacity('--color-hover-btn'),
        ...
        'count-btn-bg': withOpacity('--count-btn-bg'),
        'count-bg': withOpacity('--count-bg'),
        'hover-btn': withOpacity('--color-hover-btn'),
        grey: withOpacity('--color-grey'),
        'newsletter-footer': withOpacity('--color-newsletter'),
        'bg-text-banner': withOpacity('--color-bg-text-banner'),
        'bg-button': withOpacity('--color-bg-button'),
        'border-light': withOpacity('--border-light'),
        'vinoteca-heading': withOpacity(' --color-heading-vinoteca'),
        social: {
          facebook: '#3b5998',
