...
export default function MobileNavigation({
  ...
  return (
    <div className="z visible h-12 md:h-14 lg:hidden">
      <nav className="fixed bottom-0 z-20 flex h-12 w-full justify-between bg-light py-1.5 px-2 shadow-400 ltr:left-0 rtl:right-0 md:h-14">
        <motion.button
          whileTap={{ scale: 0.88 }}
