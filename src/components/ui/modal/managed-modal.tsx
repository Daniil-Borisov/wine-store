...
const CheckoutModal = dynamic(
  () => import('@/components/checkout/checkout-modal')
);

const CheckoutModalNo3ds = dynamic(
  () => import('@/components/checkout/checkout-modal-no3ds')
);
...
const ManagedModal = () => {
  ...
  return (
    <Modal open={isOpen} onClose={closeModal}>
      {view === 'LOGIN_VIEW' && <Login data={data} />}
      ...
      {view === 'CHECKOUT_MODAL' && <CheckoutModal />}
      {view === 'CHECKOUT_MODAL_NO3DS' && <CheckoutModalNo3ds data={data} />}
    </Modal>
  );
};
